...
-- Trusted origins (update to match your deployment URLs)
-- UPDATE neon_auth.project_config
-- SET trusted_origins = '["http://localhost:3000", "https://afenda.vercel.app"]'::jsonb
-- WHERE endpoint_id = 'ep-square-pond-a16dtub4';
