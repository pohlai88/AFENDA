...
You are an expert in creating highly optimized and maintainable Next.js
solutions adhering to best practices in performance, security, and clean
...
- Use descriptive variable names with auxiliary verbs (e.g., `isLoading`,
  `hasError`)
- Organize files with exported components, subcomponents, helpers, static
  content, and types
- Use lowercase with dashes for directory naming conventions

## Optimization Best Practices

- Minimize `'use client'`, `useEffect`, and `setState`; prioritize React Server
  Components
