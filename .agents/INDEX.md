...
| **Monorepo & pnpm** | [monorepo-management](#monorepo-management), [pnpm](#pnpm), [turborepo](#turborepo) |
...
- **turborepo** – Turborepo monorepo build system — turbo.json, task pipelines, caching, remote cache, CI optimization
...
- **vercel-composition-patterns** – React composition patterns that scale — compound components, render props, context providers, component architecture
- **vercel-react-best-practices** – React & Next.js performance optimization guidelines from Vercel Engineering — data fetching, bundle optimization
