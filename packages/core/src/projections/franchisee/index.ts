/**
 * Franchisee Portal Projections
 * 
 * Projection layer for franchisee-facing portal experiences.
 * 
 * Dominant domain: Franchise Management
 * Supporting domains: Accounts Receivable, Operations
 * 
