...
| `fx-exposure.service.ts`                    | `createFxExposure`, `closeFxExposure`                                                                                           |
| `fx-exposure.queries.ts`                    | `listFxExposures`, `getFxExposureById`                                                                                          |
| `hedge-designation.service.ts`              | `createHedgeDesignation`, `updateHedgeDesignationStatus`                                                                        |
| `hedge-designation.queries.ts`              | `listHedgeDesignations`, `getHedgeDesignationById`                                                                              |
| `revaluation-event.service.ts`              | `createRevaluationEvent`, `updateRevaluationEventStatus`                                                                        |
| `revaluation-event.queries.ts`              | `listRevaluationEvents`, `getRevaluationEventById`                                                                              |
...
| `netting-session.service.ts`                | `NettingSessionService`                                                                                                         |
| `netting-session.queries.ts`                | `NettingSessionQueries`                                                                                                         |
| `internal-interest-rate.service.ts`         | `InternalInterestRateService`                                                                                                   |
| `calculators/internal-interest.ts`          | `calculateInternalInterestMinor`, `buildNetPositions`                                                                           |
| `bank-connector.service.ts`                 | `BankConnectorService` (createBankConnector, requestBankConnectorSync, createMarketDataFeed, requestMarketDataRefresh)          |
| `bank-connector.queries.ts`                 | `BankConnectorQueries` (listBankConnectors, listBankConnectorExecutions, listMarketDataFeeds, listMarketDataObservations)       |
| `treasury-policy.service.ts`                | `TreasuryPolicyService` (createTreasuryPolicy, activateTreasuryPolicy, createTreasuryLimit, activateTreasuryLimit, checkLimits) |
| `treasury-policy.queries.ts`                | `TreasuryPolicyQueries` (listPolicies, listLimits, listBreaches)                                                                |
| `treasury-accounting-bridge.service.ts`     | `TreasuryAccountingBridgeService` (createPolicy, activatePolicy, requestPosting)                                                |
| `treasury-accounting-bridge.queries.ts`     | `TreasuryAccountingBridgeQueries` (listPolicies, listPostingRequests)                                                           |
...
| 4.2    | `netting-session.service.ts`                | Netting session lifecycle and settlement readiness                 |
| 4.2    | `netting-session.queries.ts`                | Netting session/item and interest-rate read models                 |
| 4.2    | `internal-interest-rate.service.ts`         | Internal interest policy create/activate lifecycle                 |
| 4.2    | `calculators/internal-interest.ts`          | Day-count accrual and netting position calculations                |
