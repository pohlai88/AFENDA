...
| 4.2    | `netting-session.entity.ts`                  | `nettingSessionEntitySchema`, `nettingSessionItemEntitySchema`                                                                                      | Netting session + included obligation contracts   |
| 4.2    | `netting-session.commands.ts`                | `createNettingSessionCommandSchema`, `addNettingSessionItemsCommandSchema`, `closeNettingSessionCommandSchema`, `settleNettingSessionCommandSchema` | Netting lifecycle commands                        |
| 4.2    | `internal-interest-rate.entity.ts`           | `internalInterestRateEntitySchema`, `internalInterestDayCountValues`                                                                                | Internal treasury interest policy contract        |
| 4.2    | `internal-interest-rate.commands.ts`         | `createInternalInterestRateCommandSchema`, `activateInternalInterestRateCommandSchema`                                                              | Internal interest policy create/activate commands |
