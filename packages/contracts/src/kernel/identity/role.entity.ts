 ...
 * automatically.
 *
 * Naming convention: `scope.noun` or `scope.noun.verb` — lowercase, hyphens
 * allowed within segments (e.g. `admin.custom-fields.read`). Enforced at parse
 * time by PERM_PATTERN.
 */
export const Permissions = {
  ...
  // ── Admin — Org management (ADR-0003: "org" replaces legacy "tenant") ───────
  adminOrgManage:     "admin.org.manage",
  ...
  // ── Admin — Custom Fields ───────────────────────────────────────────────────
  adminCustomFieldsRead:  "admin.custom-fields.read",
  adminCustomFieldsWrite: "admin.custom-fields.write",
 ...
 * Hyphens are allowed within each segment (e.g. `admin.custom-fields.read`).
 */
const PERM_PATTERN = /^[a-z][a-z-]*(\.[a-z][a-z-]*)+$/;
