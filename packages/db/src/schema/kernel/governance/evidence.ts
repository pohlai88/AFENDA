...
export const document = pgTable(
  "document",
  {
    ...
    uploadedByPrincipalId: uuid("uploaded_by_principal_id").references(() => iamPrincipal.id, {
      onDelete: "set null",
    }),
...
export const evidence = pgTable(
  "evidence",
  {
    ...
    label: text("label"),
    attachedByPrincipalId: uuid("attached_by_principal_id").references(() => iamPrincipal.id, {
      onDelete: "set null",
    }),
