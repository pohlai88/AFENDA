...
export const liquidityForecastBucket = pgTable(
  "liquidity_forecast_bucket",
  {
    ...
    nativeExpectedInflowsMinor: text("native_expected_inflows_minor").notNull(),
    nativeExpectedOutflowsMinor: text("native_expected_outflows_minor").notNull(),
    normalizedExpectedInflowsMinor: text("normalized_expected_inflows_minor").notNull(),
    normalizedExpectedOutflowsMinor: text("normalized_expected_outflows_minor").notNull(),
