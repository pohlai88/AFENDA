 ...
 *
 * Copy this file to: apps/api/src/routes/erp/supplier/supplier-bank-account.ts
...
// import { z } from "zod";
// import {
//   CreateSupplierBankAccountCommandSchema,
//   CursorParamsSchema,
...
/**
 * <SupplierBankAccount> routes — REST endpoints for supplier-bank-account entity.
 * 
 ...
 */
// export async function supplierBankAccountRoutes(app: FastifyInstance) {
//   const typedApp = app.withTypeProvider<ZodTypeProvider>();

  // ── Command: Create ──────────────────────────────────────────────────────
  // typedApp.post("/v1/commands/create-supplier-bank-account", {
//     config: { rateLimit: { max: 30, timeWindow: "1 minute" } },
//     schema: {
//       description: "Create a new entity",
//       tags: ["entity"],
//       security: [{ bearerAuth: [] }],
//       body: CreateSupplierBankAccountCommandSchema,
//       response: {
