 ...
 *
 * Copy this file to: apps/api/src/routes/erp/supplier/supplier-site.ts
 * Then: find-replace SupplierSite/entity with your domain name.
 *
 * RULES:
...
// import { z } from "zod";
// import {
//   CreateSupplierSiteCommandSchema,
//   CursorParamsSchema,
...
/**
 * <SupplierSite> routes — REST endpoints for supplier-site entity.
 * 
 * Register in apps/api/src/index.ts:
 *   import { supplierSiteRoutes } from "./routes/erp/supplier/supplier-site.js";
 *   await app.register(supplierSiteRoutes, { prefix: "/v1" });
 */
// export async function supplierSiteRoutes(app: FastifyInstance) {
//   const typedApp = app.withTypeProvider<ZodTypeProvider>();

  // ── Command: Create ──────────────────────────────────────────────────────
  // typedApp.post("/v1/commands/create-supplier-site", {
//     config: { rateLimit: { max: 30, timeWindow: "1 minute" } },
//     schema: {
//       description: "Create a new entity",
//       tags: ["entity"],
//       security: [{ bearerAuth: [] }],
//       body: CreateSupplierSiteCommandSchema,
//       response: {
