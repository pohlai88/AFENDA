...
import { CreateRequisitionCommandSchema, CreateRequisitionResultSchema } from "@afenda/contracts";
...
const BodySchema = CreateRequisitionCommandSchema.omit({ idempotencyKey: true });
const ResponseSchema = makeSuccessSchema(CreateRequisitionResultSchema);
