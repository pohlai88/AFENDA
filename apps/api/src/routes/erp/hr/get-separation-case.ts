...
const ResponseSchema = makeSuccessSchema(z.object({ separationCaseId: z.string().uuid(), employmentId: z.string().uuid(), caseStatus: z.string(), separationType: z.string().nullable(), initiatedAt: z.string().nullable(), targetLastWorkingDate: z.string().nullable(), closedAt: z.string().nullable(), items: z.array(z.object({ itemId: z.string().uuid(), itemCode: z.string().nullable(), itemLabel: z.string(), ownerEmployeeId: z.string().uuid().nullable(), mandatory: z.boolean(), clearanceStatus: z.string(), clearedAt: z.string().nullable() })) }));
