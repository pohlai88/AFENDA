...
import { submitPayrollRun } from "@afenda/core";
import { z } from "zod";
import {
...
export async function hrSubmitPayrollRunRoutes(app: FastifyInstance) {
  const typed = app.withTypeProvider<ZodTypeProvider>();

  typed.post(
    "/hrm/payroll/runs/:payrollRunId/submit",
    {
      schema: {
        description: "Submit a payroll run.",
        tags: ["HRM", "Payroll"],
