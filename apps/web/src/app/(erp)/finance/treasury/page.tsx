...
export default async function TreasuryPage() {
  ...
  try {
    ...
    activeAccountCount = accounts.data.filter(
      (a) => a.status === "active",
    ).length;
  } catch {
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mb-6 max-w-sm text-sm text-muted-foreground">
              Set up your first bank account and import statements to start managing cash flow
              and reconciliation.
            </p>
            <Button asChild>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button asChild className="w-full" variant="outline">
                <Link href="/finance/treasury/bank-accounts">
                  Manage Accounts
                </Link>
              </Button>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ingest and reconcile bank statements from your financial
                institutions.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Match statement lines to transactions and close reconciliation
                  sessions.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button asChild className="w-full" variant="outline">
                  <Link href="/finance/treasury/reconciliation">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create payment instructions, submit for approval, and release
                  in batches.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button asChild className="w-full" variant="outline">
                  <Link href="/finance/treasury/payments">
                    Manage Payments
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button asChild className="w-full" variant="outline">
                  <Link href="/finance/treasury/cash-position">
                    View Cash Position
                  </Link>
                </Button>
              </CardContent>
